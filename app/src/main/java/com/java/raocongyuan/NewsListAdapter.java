...
public class NewsListAdapter extends RecyclerView.Adapter<NewsListAdapter.NewsListViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NewsListViewHolder holder, final int position) {
        ...
        if(holder instanceof NewsListViewHolder){
            ...
            holder.txtTitle.setText(newsItem.getTitle().replace((char)12288+"",""));
            holder.txtAbstract.setText(newsItem.getAbstractText().replace((char)12288+"",""));
            ...
            //Date and Time
            if(newsItem.getDateAndTime()!=null)
                holder.item_date_time.setText(newsItem.getDateAndTime());
            else
